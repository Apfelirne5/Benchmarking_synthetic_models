...
def get_data_loaders(args):
    ...
    train_dataset = datasets.DTD(args.data, split="train", transform=train_transform, download=True)
    val_dataset = datasets.DTD(args.data, split="val", transform=val_transform, download=True)
