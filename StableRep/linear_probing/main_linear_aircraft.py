...
def get_data_loaders(args):
    ...
    train_dataset = datasets.FGVCAircraft(args.data, split="train", transform=train_transform, download=True)
    val_dataset = datasets.FGVCAircraft(args.data, split="val", transform=val_transform, download=True)
