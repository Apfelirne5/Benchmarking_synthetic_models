...
model_checkpoint = "../Models/Synthetic/imagenet_1k_sd.pth"
...
if __name__ == "__main__":
    ...
    custom_target=867  #None for setting the highest output as the target or set the targetlabel from 0 to 999
)
